...
@Component
public class AuthRoleToPermissionsMapper implements DtoMapper<AuthRoleToPermissionsDto, AuthRoleToPermissions>, EntityMapper<AuthRoleToPermissions, AuthRoleToPermissionsDto> {
